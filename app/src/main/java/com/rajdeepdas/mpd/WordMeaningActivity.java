...
import com.rajdeepdas.mpd.fragments.FragmentAntonyms;
import com.rajdeepdas.mpd.fragments.FragmentDefinition;
import com.rajdeepdas.mpd.fragments.FragmentExample;
import com.rajdeepdas.mpd.fragments.FragmentSynonyms;
...
public class WordMeaningActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (c.moveToFirst()) {
            ...
            myDbHelper.insertHistory1(enWord);
        ...
        Button btnSearch =(Button)findViewById(R.id.search_web);

        btnSearch.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {

                Intent browserIntent = new Intent(Intent.ACTION_VIEW, Uri.parse("http://www.google.com/search?q="+enWord));
        ...
        btnAdd.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Toast.makeText(WordMeaningActivity.this,enWord+"  Saved", Toast.LENGTH_SHORT).show();
